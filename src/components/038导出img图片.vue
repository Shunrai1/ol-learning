...
<template>
    <div class="container">
        <h3>vue+openlayers: 导出地图（image）</h3>
        <p>文件来源：https://xiaozhuanlan.com/vue-openlayers</p>
		<h4><el-button type="danger" @click="exportmap" size="mini" >导出地图</el-button></h4>
        <div id="vue-openlayers"></div>
		<!-- 导出地图映射到a标签上 -->
        <a id="image-download" download="map-img.jpg"></a>
    </div>
</template>
<script>
    import 'ol/ol.css';
			...
			exportmap(){
				 this.map.once('rendercomplete', ()=>{
				   ...
				   if (navigator.msSaveBlob) {
					 ...
					 navigator.msSaveBlob(mapCanvas.msToBlob(), 'map-img.jpg');
				   } else {
