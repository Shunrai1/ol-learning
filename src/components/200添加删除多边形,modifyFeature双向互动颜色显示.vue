...
<template>
	<div class="container">
		<h3>vue+openlayers：添加删除多边形，modify feature，双向互动颜色显示</h3>
		<p>大剑师兰特, 还是大剑师兰特</p>
		<h4>
			<el-button type="success" size="mini" @click='drawNew()'>新增绘制</el-button>
			<el-button type="success" size="mini" @click='editSelected()'>编辑所选</el-button>
			<el-button type="success" size="mini" @click='clear()'>清空图层</el-button>
		</h4>
