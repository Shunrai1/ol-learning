...
<template>
  <div class="container">
    <h3>vue+openlayers:绘制矩形,截取对应部分的地图并保存</h3>
    <p>大剑师兰特, 还是大剑师兰特</p>
    <h4>
      <el-button type="primary" size="mini" @click="drawBox()"
        >绘制矩形截图</el-button
      >
      <el-button type="danger" size="mini" @click="clearSource()"
        >清除图层</el-button
      >
    </h4>
