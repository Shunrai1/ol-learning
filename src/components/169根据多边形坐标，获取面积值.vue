...
<template>
	<div class="container">
		<h3>vue+openlayers: 根据多边形坐标，获取面积值</h3>
		<p>大剑师兰特, 还是大剑师兰特</p>
		<h4>
			<el-button type="primary" size="mini" @click="showArea()">获取面积			
			</el-button>
...
<script>
	...
	export default {
		...
		methods: {
			...
			showArea() {
              let polygon = turf.polygon([[[125, -15], [113, -22], [154, -26], [144, -14], [125, -15]]]);
              this.show(polygon)
              this.area = Math.round( turf.area(polygon)/1000000);
			},
