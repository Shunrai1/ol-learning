...
* @First published time: 2022-10-10
*/

<template>
	<div class="container">
		<h3>vue+openlayers: 测量长度和面积，尾随数字和关闭按钮</h3>
		<p>大剑师兰特, 还是大剑师兰特</p>
		<h4>
			<el-button type="primary" size="mini" @click=' measure("LineString")'>测量长度 </el-button>
			<el-button type="primary" size="mini" @click=' measure("Polygon")'>测量面积 </el-button>
		</h4>
