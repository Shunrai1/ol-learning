...
* @First published time: 2024-03-28
*/
<template>
	<div class="container">
		        <h3>vue+openlayers: 高德地图坐标转换 WGS84-GCJ02</h3>
		        <p>大剑师兰特, 还是大剑师兰特</p>
              <h4>
				<el-button type="primary" size="mini" @click="showPoint1()">转化前</el-button>
				<el-button type="danger" size="mini" @click="showPoint2()">转化后</el-button>
...
<script>
	...
	export default {
		...
		methods: {
            ...
            /**
             * 将 WGS84坐标转化为GCJ02坐标，从而使得高德地图能正确的显示物体的坐标点。
             * @param wgLon 
             * @param wgLat 
             */
			transform22(wgLon, wgLat) {
			...
			showPoint2() {
               let  gd_coordinate=this.transform22(this.pointData[0], this.pointData[1])
