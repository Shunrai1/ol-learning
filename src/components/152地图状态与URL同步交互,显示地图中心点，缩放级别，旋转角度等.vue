...
<template>
    <div class="container">
        <h3>vue+openlayers: 使用Link在URL上显示地图中心点、zoom level、旋转角度信息</h3>
        <p>大剑师兰特, 还是大剑师兰特</p>
...
<script>
	...
	import Link from 'ol/interaction/Link'; //核心代码
    ...
    export default {
		...
		this.map.addInteraction(new Link()); //核心代码
            },

        },
        mounted() {
            this.initMap();
            this.maptiler("streets");
        }
    }
</script>
<style scoped>
