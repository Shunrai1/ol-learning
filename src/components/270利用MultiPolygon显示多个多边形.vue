...
<template>
	<div class="container">
		<h3>vue+openlayers: 利用 MultiPolygon 显示多个多边形</h3>
		<p>大剑师兰特, 还是大剑师兰特</p>
		<h4>
			<el-button type="primary" size="mini" @click="drawImage()">显示多多边形</el-button>
	...
	export default {
		...
		methods: {
			drawImage() {
				...
				this.source.addFeature(MultiPolygonFeature);
			},
			...
			initMap() {
				...
				this.map = new Map({
					...
					layers: [raster, this.MultiPolygonLayer],
					view: new View({
